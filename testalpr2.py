...
parser.add_argument("--config", dest="config", action="store", default="/home/pi/openalpr3/config/openalpr.conf.defaults",
                  help="Path to openalpr.conf config file" )

parser.add_argument("--runtime_data", dest="runtime_data", action="store", default="/home/pi/openalpr3/runtime_data",
                  help="Path to OpenALPR runtime_data directory" )

parser.add_argument('/home/pi/Documents/projects/django-alpr/templates/alpr_capture.jpg', help='License plate image file')
