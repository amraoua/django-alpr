...
def openALPR(): #reading the picture
    ...
    try:
        ...
        if not alpr.is_loaded():
            ...
            jpeg_bytes = open('/home/pi/Documents/projects/django-alpr/templates/alpr_capture.jpg', "rb").read() #testing
...
def upload(): #upload to database
    ...
    file = open('/home/pi/Documents/projects/django-alpr/testalpr/NumberPlate/Database.txt','a') #you have to make a blank file on ownCloud and then use its location
    file.write(filename+'\n')
    for x in database:
        y = [x[0],x[1]]
        file.write(str(y))
